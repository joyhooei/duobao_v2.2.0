$(function(){
	try{
		...
		awardGetData();
		dropRefresh("#p-award-point",awardRefresh);	//下拉刷新
	}catch(e){
...
function awardStatus(awardObj){
	...
	$(".j-confirm-box").html("");
	$(".j-finish-box").html(awardObj.lotteryTime);
...
function awardFillData(n){
	...
	if ($("#p-award-point").find(".module2").length > 0) {
		$("#p-award-point").find(".module2").remove();
	}
	
	$("#p-award-point").find(".module-first").after(
...
function awardAddFillData(n,o){
	...
	if ($("#p-award-point").find(".module3").length > 0) {
		$("#p-award-point").find(".module3").remove();
	}
...
function awardShipFillData(n){
	...
	if ($("#p-award-point").find(".module4").length > 0) {
		$("#p-award-point").find(".module4").remove();
	}
